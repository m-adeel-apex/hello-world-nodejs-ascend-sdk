...
/** @internal */
exports.AccountsListAvailableRestrictionsRequest$outboundSchema = z.object({
    accountId: z.string(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var AccountsListAvailableRestrictionsRequest$;
(function (AccountsListAvailableRestrictionsRequest$) {
    ...
    AccountsListAvailableRestrictionsRequest$.inboundSchema = exports.AccountsListAvailableRestrictionsRequest$inboundSchema;
...
/** @internal */
exports.AccountsListAvailableRestrictionsResponse$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var AccountsListAvailableRestrictionsResponse$;
(function (AccountsListAvailableRestrictionsResponse$) {
    ...
    AccountsListAvailableRestrictionsResponse$.inboundSchema = exports.AccountsListAvailableRestrictionsResponse$inboundSchema;
