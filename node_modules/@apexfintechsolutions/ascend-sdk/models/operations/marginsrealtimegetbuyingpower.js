...
/** @internal */
exports.MarginsRealTimeGetBuyingPowerRequest$outboundSchema = z.object({
    accountId: z.string(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var MarginsRealTimeGetBuyingPowerRequest$;
(function (MarginsRealTimeGetBuyingPowerRequest$) {
    /** @deprecated use `MarginsRealTimeGetBuyingPowerRequest$inboundSchema` instead. */
    MarginsRealTimeGetBuyingPowerRequest$.inboundSchema = exports.MarginsRealTimeGetBuyingPowerRequest$inboundSchema;
...
/** @internal */
exports.MarginsRealTimeGetBuyingPowerResponse$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var MarginsRealTimeGetBuyingPowerResponse$;
(function (MarginsRealTimeGetBuyingPowerResponse$) {
    /** @deprecated use `MarginsRealTimeGetBuyingPowerResponse$inboundSchema` instead. */
    MarginsRealTimeGetBuyingPowerResponse$.inboundSchema = exports.MarginsRealTimeGetBuyingPowerResponse$inboundSchema;
