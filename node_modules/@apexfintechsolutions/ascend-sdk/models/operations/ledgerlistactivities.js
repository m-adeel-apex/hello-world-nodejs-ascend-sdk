...
/** @internal */
exports.LedgerListActivitiesRequest$outboundSchema = z.object({
    accountId: z.string(),
 ...
 */
var LedgerListActivitiesRequest$;
(function (LedgerListActivitiesRequest$) {
    /** @deprecated use `LedgerListActivitiesRequest$inboundSchema` instead. */
    LedgerListActivitiesRequest$.inboundSchema = exports.LedgerListActivitiesRequest$inboundSchema;
...
/** @internal */
exports.LedgerListActivitiesResponse$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var LedgerListActivitiesResponse$;
(function (LedgerListActivitiesResponse$) {
    /** @deprecated use `LedgerListActivitiesResponse$inboundSchema` instead. */
    LedgerListActivitiesResponse$.inboundSchema = exports.LedgerListActivitiesResponse$inboundSchema;
