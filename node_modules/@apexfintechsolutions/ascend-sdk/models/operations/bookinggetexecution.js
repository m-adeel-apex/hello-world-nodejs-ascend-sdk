...
/** @internal */
exports.BookingGetExecutionRequest$outboundSchema = z.object({
    accountId: z.string(),
    tradeId: z.string(),
 ...
 */
var BookingGetExecutionRequest$;
(function (BookingGetExecutionRequest$) {
    /** @deprecated use `BookingGetExecutionRequest$inboundSchema` instead. */
    BookingGetExecutionRequest$.inboundSchema = exports.BookingGetExecutionRequest$inboundSchema;
...
/** @internal */
exports.BookingGetExecutionResponse$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var BookingGetExecutionResponse$;
(function (BookingGetExecutionResponse$) {
    /** @deprecated use `BookingGetExecutionResponse$inboundSchema` instead. */
    BookingGetExecutionResponse$.inboundSchema = exports.BookingGetExecutionResponse$inboundSchema;
