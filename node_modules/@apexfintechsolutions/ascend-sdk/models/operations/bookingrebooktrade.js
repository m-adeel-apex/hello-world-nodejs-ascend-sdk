...
/** @internal */
exports.BookingRebookTradeRequest$outboundSchema = z.object({
    accountId: z.string(),
    tradeId: z.string(),
 ...
 */
var BookingRebookTradeRequest$;
(function (BookingRebookTradeRequest$) {
    /** @deprecated use `BookingRebookTradeRequest$inboundSchema` instead. */
    BookingRebookTradeRequest$.inboundSchema = exports.BookingRebookTradeRequest$inboundSchema;
...
/** @internal */
exports.BookingRebookTradeResponse$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var BookingRebookTradeResponse$;
(function (BookingRebookTradeResponse$) {
    /** @deprecated use `BookingRebookTradeResponse$inboundSchema` instead. */
    BookingRebookTradeResponse$.inboundSchema = exports.BookingRebookTradeResponse$inboundSchema;
