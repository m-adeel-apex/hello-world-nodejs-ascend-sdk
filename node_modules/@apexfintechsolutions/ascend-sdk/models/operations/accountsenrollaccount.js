...
/** @internal */
exports.AccountsEnrollAccountRequest$outboundSchema = z.object({
    accountId: z.string(),
 ...
 */
var AccountsEnrollAccountRequest$;
(function (AccountsEnrollAccountRequest$) {
    /** @deprecated use `AccountsEnrollAccountRequest$inboundSchema` instead. */
    AccountsEnrollAccountRequest$.inboundSchema = exports.AccountsEnrollAccountRequest$inboundSchema;
...
/** @internal */
exports.AccountsEnrollAccountResponse$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var AccountsEnrollAccountResponse$;
(function (AccountsEnrollAccountResponse$) {
    /** @deprecated use `AccountsEnrollAccountResponse$inboundSchema` instead. */
    AccountsEnrollAccountResponse$.inboundSchema = exports.AccountsEnrollAccountResponse$inboundSchema;
