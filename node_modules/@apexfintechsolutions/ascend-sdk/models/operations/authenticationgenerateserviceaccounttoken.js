...
/** @internal */
exports.AuthenticationGenerateServiceAccountTokenSecurity$outboundSchema = z.object({
    apiKeyAuth: z.string(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        apiKeyAuth: "ApiKeyAuth",
 ...
 */
var AuthenticationGenerateServiceAccountTokenSecurity$;
(function (AuthenticationGenerateServiceAccountTokenSecurity$) {
    ...
    AuthenticationGenerateServiceAccountTokenSecurity$.inboundSchema = exports.AuthenticationGenerateServiceAccountTokenSecurity$inboundSchema;
...
/** @internal */
exports.AuthenticationGenerateServiceAccountTokenResponse$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var AuthenticationGenerateServiceAccountTokenResponse$;
(function (AuthenticationGenerateServiceAccountTokenResponse$) {
    ...
    AuthenticationGenerateServiceAccountTokenResponse$.inboundSchema = exports.AuthenticationGenerateServiceAccountTokenResponse$inboundSchema;
