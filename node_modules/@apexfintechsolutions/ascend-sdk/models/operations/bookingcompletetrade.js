...
/** @internal */
exports.BookingCompleteTradeRequest$outboundSchema = z.object({
    accountId: z.string(),
    tradeId: z.string(),
 ...
 */
var BookingCompleteTradeRequest$;
(function (BookingCompleteTradeRequest$) {
    /** @deprecated use `BookingCompleteTradeRequest$inboundSchema` instead. */
    BookingCompleteTradeRequest$.inboundSchema = exports.BookingCompleteTradeRequest$inboundSchema;
...
/** @internal */
exports.BookingCompleteTradeResponse$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var BookingCompleteTradeResponse$;
(function (BookingCompleteTradeResponse$) {
    /** @deprecated use `BookingCompleteTradeResponse$inboundSchema` instead. */
    BookingCompleteTradeResponse$.inboundSchema = exports.BookingCompleteTradeResponse$inboundSchema;
