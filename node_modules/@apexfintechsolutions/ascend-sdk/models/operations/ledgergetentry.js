...
/** @internal */
exports.LedgerGetEntryRequest$outboundSchema = z.object({
    accountId: z.string(),
    entryId: z.string(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var LedgerGetEntryRequest$;
(function (LedgerGetEntryRequest$) {
    /** @deprecated use `LedgerGetEntryRequest$inboundSchema` instead. */
    LedgerGetEntryRequest$.inboundSchema = exports.LedgerGetEntryRequest$inboundSchema;
...
/** @internal */
exports.LedgerGetEntryResponse$outboundSchema = z.object({
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var LedgerGetEntryResponse$;
(function (LedgerGetEntryResponse$) {
    /** @deprecated use `LedgerGetEntryResponse$inboundSchema` instead. */
    LedgerGetEntryResponse$.inboundSchema = exports.LedgerGetEntryResponse$inboundSchema;
