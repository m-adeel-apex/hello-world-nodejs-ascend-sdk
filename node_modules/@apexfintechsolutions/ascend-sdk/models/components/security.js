...
/** @internal */
exports.ServiceAccountCreds$outboundSchema = z.object({
    privateKey: z.string(),
    name: z.string(),
    organization: z.string(),
    type: z.string(),
...
(function (ServiceAccountCreds$) {
    ...
    ServiceAccountCreds$.inboundSchema = exports.ServiceAccountCreds$inboundSchema;
...
exports.Security$inboundSchema = z.object({
    ...
    serviceAccountCreds: z.lazy(() => exports.ServiceAccountCreds$inboundSchema)
        .optional(),
});
/** @internal */
exports.Security$outboundSchema = z.object({
    apiKey: z.string().optional(),
    serviceAccountCreds: z.lazy(() => exports.ServiceAccountCreds$outboundSchema)
        .optional(),
});
/**
 * @internal
