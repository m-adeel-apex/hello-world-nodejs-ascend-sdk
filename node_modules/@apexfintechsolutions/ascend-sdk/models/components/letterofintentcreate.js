...
/** @internal */
exports.LetterOfIntentCreate$inboundSchema = z.object({
    amount: decimalcreate_js_1.DecimalCreate$inboundSchema,
    period_start_date: datecreate_js_1.DateCreate$inboundSchema,
}).transform((v) => {
...
/** @internal */
exports.LetterOfIntentCreate$outboundSchema = z.object({
    amount: decimalcreate_js_1.DecimalCreate$outboundSchema,
    periodStartDate: datecreate_js_1.DateCreate$outboundSchema,
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var LetterOfIntentCreate$;
(function (LetterOfIntentCreate$) {
    /** @deprecated use `LetterOfIntentCreate$inboundSchema` instead. */
    LetterOfIntentCreate$.inboundSchema = exports.LetterOfIntentCreate$inboundSchema;
