...
exports.ListScheduleSummariesResponse$inboundSchema = z.object({
    ...
    schedule_summaries: z.array(transferschedulesummary_js_1.TransferScheduleSummary$inboundSchema).optional(),
}).transform((v) => {
...
/** @internal */
exports.ListScheduleSummariesResponse$outboundSchema = z.object({
    nextPageToken: z.string().optional(),
    scheduleSummaries: z.array(transferschedulesummary_js_1.TransferScheduleSummary$outboundSchema).optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var ListScheduleSummariesResponse$;
(function (ListScheduleSummariesResponse$) {
    /** @deprecated use `ListScheduleSummariesResponse$inboundSchema` instead. */
    ListScheduleSummariesResponse$.inboundSchema = exports.ListScheduleSummariesResponse$inboundSchema;
