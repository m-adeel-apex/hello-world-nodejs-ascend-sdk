...
exports.BeneficiaryEnrollmentMetadataCreate$inboundSchema = z.object({
    contingent_beneficiaries: z.array(beneficiarycreate_js_1.BeneficiaryCreate$inboundSchema).optional(),
    primary_beneficiaries: z.array(beneficiarycreate_js_1.BeneficiaryCreate$inboundSchema),
}).transform((v) => {
...
/** @internal */
exports.BeneficiaryEnrollmentMetadataCreate$outboundSchema = z.object({
    contingentBeneficiaries: z.array(beneficiarycreate_js_1.BeneficiaryCreate$outboundSchema).optional(),
    primaryBeneficiaries: z.array(beneficiarycreate_js_1.BeneficiaryCreate$outboundSchema),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var BeneficiaryEnrollmentMetadataCreate$;
(function (BeneficiaryEnrollmentMetadataCreate$) {
    /** @deprecated use `BeneficiaryEnrollmentMetadataCreate$inboundSchema` instead. */
    BeneficiaryEnrollmentMetadataCreate$.inboundSchema = exports.BeneficiaryEnrollmentMetadataCreate$inboundSchema;
