...
/** @internal */
export declare const PostalAddress$inboundSchema: z.ZodType<PostalAddress, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const PostalAddress$outboundSchema: z.ZodType<PostalAddress$Outbound, z.ZodTypeDef, PostalAddress>;
/**
 * @internal
...
export declare namespace PostalAddress$ {
    ...
    const inboundSchema: z.ZodType<PostalAddress, z.ZodTypeDef, unknown>;
    /** @deprecated use `PostalAddress$outboundSchema` instead. */
    const outboundSchema: z.ZodType<PostalAddress$Outbound, z.ZodTypeDef, PostalAddress>;
    /** @deprecated use `PostalAddress$Outbound` instead. */
    type Outbound = PostalAddress$Outbound;
}
