...
exports.AchDepositScheduleUpdate$inboundSchema = z.object({
    schedule_details: depositscheduledetailsupdate_js_1.DepositScheduleDetailsUpdate$inboundSchema.optional(),
}).transform((v) => {
...
/** @internal */
exports.AchDepositScheduleUpdate$outboundSchema = z.object({
    scheduleDetails: depositscheduledetailsupdate_js_1.DepositScheduleDetailsUpdate$outboundSchema.optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var AchDepositScheduleUpdate$;
(function (AchDepositScheduleUpdate$) {
    /** @deprecated use `AchDepositScheduleUpdate$inboundSchema` instead. */
    AchDepositScheduleUpdate$.inboundSchema = exports.AchDepositScheduleUpdate$inboundSchema;
