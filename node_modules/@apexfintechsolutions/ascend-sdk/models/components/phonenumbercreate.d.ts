...
import { PhoneNumberShortCodeCreate, PhoneNumberShortCodeCreate$Outbound } from "./phonenumbershortcodecreate.js";
/**
...
export type PhoneNumberCreate = {
     ...
     */
    shortCode?: PhoneNumberShortCodeCreate | undefined;
};
/** @internal */
export declare const PhoneNumberCreate$inboundSchema: z.ZodType<PhoneNumberCreate, z.ZodTypeDef, unknown>;
/** @internal */
export type PhoneNumberCreate$Outbound = {
    e164_number?: string | undefined;
    extension?: string | undefined;
    short_code?: PhoneNumberShortCodeCreate$Outbound | undefined;
};
/** @internal */
export declare const PhoneNumberCreate$outboundSchema: z.ZodType<PhoneNumberCreate$Outbound, z.ZodTypeDef, PhoneNumberCreate>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace PhoneNumberCreate$ {
    /** @deprecated use `PhoneNumberCreate$inboundSchema` instead. */
    const inboundSchema: z.ZodType<PhoneNumberCreate, z.ZodTypeDef, unknown>;
    /** @deprecated use `PhoneNumberCreate$outboundSchema` instead. */
    const outboundSchema: z.ZodType<PhoneNumberCreate$Outbound, z.ZodTypeDef, PhoneNumberCreate>;
    /** @deprecated use `PhoneNumberCreate$Outbound` instead. */
    type Outbound = PhoneNumberCreate$Outbound;
}
//# sourceMappingURL=phonenumbercreate.d.ts.map