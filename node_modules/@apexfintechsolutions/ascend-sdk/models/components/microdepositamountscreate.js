...
exports.MicroDepositAmountsCreate$inboundSchema = z.object({
    amount1: decimalcreate_js_1.DecimalCreate$inboundSchema,
    amount2: decimalcreate_js_1.DecimalCreate$inboundSchema,
});
/** @internal */
exports.MicroDepositAmountsCreate$outboundSchema = z.object({
    amount1: decimalcreate_js_1.DecimalCreate$outboundSchema,
    amount2: decimalcreate_js_1.DecimalCreate$outboundSchema,
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var MicroDepositAmountsCreate$;
(function (MicroDepositAmountsCreate$) {
    /** @deprecated use `MicroDepositAmountsCreate$inboundSchema` instead. */
    MicroDepositAmountsCreate$.inboundSchema = exports.MicroDepositAmountsCreate$inboundSchema;
