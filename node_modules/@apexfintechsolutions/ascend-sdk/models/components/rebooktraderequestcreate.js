...
exports.RebookTradeRequestCreate$inboundSchema = z.object({
    name: z.string(),
    trade: tradecreate_js_1.TradeCreate$inboundSchema,
});
/** @internal */
exports.RebookTradeRequestCreate$outboundSchema = z.object({
    name: z.string(),
    trade: tradecreate_js_1.TradeCreate$outboundSchema,
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var RebookTradeRequestCreate$;
(function (RebookTradeRequestCreate$) {
    /** @deprecated use `RebookTradeRequestCreate$inboundSchema` instead. */
    RebookTradeRequestCreate$.inboundSchema = exports.RebookTradeRequestCreate$inboundSchema;
