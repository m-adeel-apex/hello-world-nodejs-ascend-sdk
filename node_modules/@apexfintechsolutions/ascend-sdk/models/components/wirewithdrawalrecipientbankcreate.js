...
/** @internal */
exports.WireWithdrawalRecipientBankCreate$inboundSchema = z.object({
    bank_id: recipientbankbankidcreate_js_1.RecipientBankBankIdCreate$inboundSchema,
    international_bank_details: recipientbankbankdetailscreate_js_1.RecipientBankBankDetailsCreate$inboundSchema
        .optional(),
}).transform((v) => {
...
/** @internal */
exports.WireWithdrawalRecipientBankCreate$outboundSchema = z.object({
    bankId: recipientbankbankidcreate_js_1.RecipientBankBankIdCreate$outboundSchema,
    internationalBankDetails: recipientbankbankdetailscreate_js_1.RecipientBankBankDetailsCreate$outboundSchema
        .optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
        bankId: "bank_id",
 ...
 */
var WireWithdrawalRecipientBankCreate$;
(function (WireWithdrawalRecipientBankCreate$) {
    /** @deprecated use `WireWithdrawalRecipientBankCreate$inboundSchema` instead. */
    WireWithdrawalRecipientBankCreate$.inboundSchema = exports.WireWithdrawalRecipientBankCreate$inboundSchema;
