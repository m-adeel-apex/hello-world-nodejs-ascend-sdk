...
/** @internal */
export declare const IdentityVerificationResultUpdate$inboundSchema: z.ZodType<IdentityVerificationResultUpdate, z.ZodTypeDef, unknown>;
/** @internal */
...
/** @internal */
export declare const IdentityVerificationResultUpdate$outboundSchema: z.ZodType<IdentityVerificationResultUpdate$Outbound, z.ZodTypeDef, IdentityVerificationResultUpdate>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace IdentityVerificationResultUpdate$ {
    /** @deprecated use `IdentityVerificationResultUpdate$inboundSchema` instead. */
    const inboundSchema: z.ZodType<IdentityVerificationResultUpdate, z.ZodTypeDef, unknown>;
    /** @deprecated use `IdentityVerificationResultUpdate$outboundSchema` instead. */
    const outboundSchema: z.ZodType<IdentityVerificationResultUpdate$Outbound, z.ZodTypeDef, IdentityVerificationResultUpdate>;
