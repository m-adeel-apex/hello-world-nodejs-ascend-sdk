...
exports.AddOrdersRequestCreate$inboundSchema = z.object({
    basket_orders: z.array(basketordercreate_js_1.BasketOrderCreate$inboundSchema),
    name: z.string(),
}).transform((v) => {
...
/** @internal */
exports.AddOrdersRequestCreate$outboundSchema = z.object({
    basketOrders: z.array(basketordercreate_js_1.BasketOrderCreate$outboundSchema),
    name: z.string(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var AddOrdersRequestCreate$;
(function (AddOrdersRequestCreate$) {
    /** @deprecated use `AddOrdersRequestCreate$inboundSchema` instead. */
    AddOrdersRequestCreate$.inboundSchema = exports.AddOrdersRequestCreate$inboundSchema;
