...
exports.RebookExecutionRequestCreate$inboundSchema = z.object({
    execution: executioncreate_js_1.ExecutionCreate$inboundSchema,
    name: z.string(),
});
/** @internal */
exports.RebookExecutionRequestCreate$outboundSchema = z.object({
    execution: executioncreate_js_1.ExecutionCreate$outboundSchema,
    name: z.string(),
});
/**
 * @internal
 ...
 */
var RebookExecutionRequestCreate$;
(function (RebookExecutionRequestCreate$) {
    /** @deprecated use `RebookExecutionRequestCreate$inboundSchema` instead. */
    RebookExecutionRequestCreate$.inboundSchema = exports.RebookExecutionRequestCreate$inboundSchema;
