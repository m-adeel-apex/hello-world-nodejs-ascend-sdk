 ...
 */
export type PostalAddressCreate = {
    /**
...
/** @internal */
export declare const PostalAddressCreate$inboundSchema: z.ZodType<PostalAddressCreate, z.ZodTypeDef, unknown>;
/** @internal */
export type PostalAddressCreate$Outbound = {
...
/** @internal */
export declare const PostalAddressCreate$outboundSchema: z.ZodType<PostalAddressCreate$Outbound, z.ZodTypeDef, PostalAddressCreate>;
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export declare namespace PostalAddressCreate$ {
    /** @deprecated use `PostalAddressCreate$inboundSchema` instead. */
    const inboundSchema: z.ZodType<PostalAddressCreate, z.ZodTypeDef, unknown>;
    /** @deprecated use `PostalAddressCreate$outboundSchema` instead. */
    const outboundSchema: z.ZodType<PostalAddressCreate$Outbound, z.ZodTypeDef, PostalAddressCreate>;
    /** @deprecated use `PostalAddressCreate$Outbound` instead. */
    type Outbound = PostalAddressCreate$Outbound;
}
//# sourceMappingURL=postaladdresscreate.d.ts.map