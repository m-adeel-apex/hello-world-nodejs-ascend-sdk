...
exports.ListPositionsResponse$inboundSchema = z.object({
    ...
    positions: z.array(position_js_1.Position$inboundSchema).optional(),
}).transform((v) => {
...
/** @internal */
exports.ListPositionsResponse$outboundSchema = z.object({
    nextPageToken: z.string().optional(),
    positions: z.array(position_js_1.Position$outboundSchema).optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var ListPositionsResponse$;
(function (ListPositionsResponse$) {
    /** @deprecated use `ListPositionsResponse$inboundSchema` instead. */
    ListPositionsResponse$.inboundSchema = exports.ListPositionsResponse$inboundSchema;
