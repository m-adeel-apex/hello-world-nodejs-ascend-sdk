...
exports.TransferAccountCreate$inboundSchema = z.object({
    ...
    external_account: externalaccountcreate_js_1.ExternalAccountCreate$inboundSchema.optional(),
}).transform((v) => {
...
/** @internal */
exports.TransferAccountCreate$outboundSchema = z.object({
    apexAccountId: z.string().optional(),
    externalAccount: externalaccountcreate_js_1.ExternalAccountCreate$outboundSchema.optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var TransferAccountCreate$;
(function (TransferAccountCreate$) {
    /** @deprecated use `TransferAccountCreate$inboundSchema` instead. */
    TransferAccountCreate$.inboundSchema = exports.TransferAccountCreate$inboundSchema;
