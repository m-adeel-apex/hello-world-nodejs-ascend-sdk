...
exports.ListAvailableRestrictionsResponse$inboundSchema = z.object({
    available_restrictions: z.array(availablerestriction_js_1.AvailableRestriction$inboundSchema)
        .optional(),
}).transform((v) => {
...
/** @internal */
exports.ListAvailableRestrictionsResponse$outboundSchema = z.object({
    availableRestrictions: z.array(availablerestriction_js_1.AvailableRestriction$outboundSchema)
        .optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var ListAvailableRestrictionsResponse$;
(function (ListAvailableRestrictionsResponse$) {
    /** @deprecated use `ListAvailableRestrictionsResponse$inboundSchema` instead. */
    ListAvailableRestrictionsResponse$.inboundSchema = exports.ListAvailableRestrictionsResponse$inboundSchema;
