...
exports.BatchCreateUploadLinksRequestCreate$inboundSchema = z.object({
    create_document_upload_link_request: z.array(createuploadlinkrequestcreate_js_1.CreateUploadLinkRequestCreate$inboundSchema).optional(),
}).transform((v) => {
...
/** @internal */
exports.BatchCreateUploadLinksRequestCreate$outboundSchema = z.object({
    createDocumentUploadLinkRequest: z.array(createuploadlinkrequestcreate_js_1.CreateUploadLinkRequestCreate$outboundSchema).optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var BatchCreateUploadLinksRequestCreate$;
(function (BatchCreateUploadLinksRequestCreate$) {
    /** @deprecated use `BatchCreateUploadLinksRequestCreate$inboundSchema` instead. */
    BatchCreateUploadLinksRequestCreate$.inboundSchema = exports.BatchCreateUploadLinksRequestCreate$inboundSchema;
