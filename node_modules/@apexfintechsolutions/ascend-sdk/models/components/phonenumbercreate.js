...
exports.PhoneNumberCreate$inboundSchema = z.object({
    ...
    short_code: phonenumbershortcodecreate_js_1.PhoneNumberShortCodeCreate$inboundSchema.optional(),
}).transform((v) => {
...
/** @internal */
exports.PhoneNumberCreate$outboundSchema = z.object({
    e164Number: z.string().optional(),
    extension: z.string().optional(),
    shortCode: phonenumbershortcodecreate_js_1.PhoneNumberShortCodeCreate$outboundSchema.optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var PhoneNumberCreate$;
(function (PhoneNumberCreate$) {
    /** @deprecated use `PhoneNumberCreate$inboundSchema` instead. */
    PhoneNumberCreate$.inboundSchema = exports.PhoneNumberCreate$inboundSchema;
