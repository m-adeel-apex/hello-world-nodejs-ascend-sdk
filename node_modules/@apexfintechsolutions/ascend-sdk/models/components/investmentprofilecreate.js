...
/** @internal */
exports.InvestmentProfileCreate$inboundSchema = z.object({
    account_goals: accountgoalscreate_js_1.AccountGoalsCreate$inboundSchema.optional(),
    customer_profile: customerprofilecreate_js_1.CustomerProfileCreate$inboundSchema.optional(),
}).transform((v) => {
...
/** @internal */
exports.InvestmentProfileCreate$outboundSchema = z.object({
    accountGoals: accountgoalscreate_js_1.AccountGoalsCreate$outboundSchema.optional(),
    customerProfile: customerprofilecreate_js_1.CustomerProfileCreate$outboundSchema.optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var InvestmentProfileCreate$;
(function (InvestmentProfileCreate$) {
    /** @deprecated use `InvestmentProfileCreate$inboundSchema` instead. */
    InvestmentProfileCreate$.inboundSchema = exports.InvestmentProfileCreate$inboundSchema;
