...
const googleprotobufany_js_1 = require("./googleprotobufany.js");
/** @internal */
exports.Status$inboundSchema = z
    .object({
    code: z.number().int().optional(),
    details: z.array(googleprotobufany_js_1.GoogleProtobufAny$inboundSchema).optional(),
    message: z.string().optional(),
});
/** @internal */
exports.Status$outboundSchema = z.object({
    code: z.number().int().optional(),
    details: z.array(googleprotobufany_js_1.GoogleProtobufAny$outboundSchema).optional(),
    message: z.string().optional(),
});
/**
 * @internal
