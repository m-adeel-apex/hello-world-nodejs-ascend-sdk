...
exports.BatchCreateUploadLinksResponse$inboundSchema = z.object({
    upload_link: z.array(uploadlink_js_1.UploadLink$inboundSchema).optional(),
}).transform((v) => {
...
/** @internal */
exports.BatchCreateUploadLinksResponse$outboundSchema = z.object({
    uploadLink: z.array(uploadlink_js_1.UploadLink$outboundSchema).optional(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var BatchCreateUploadLinksResponse$;
(function (BatchCreateUploadLinksResponse$) {
    /** @deprecated use `BatchCreateUploadLinksResponse$inboundSchema` instead. */
    BatchCreateUploadLinksResponse$.inboundSchema = exports.BatchCreateUploadLinksResponse$inboundSchema;
