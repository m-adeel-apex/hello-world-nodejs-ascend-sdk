...
exports.EnrollAccountRequestCreate$inboundSchema = z.object({
    enrollment: enrollmentcreate_js_1.EnrollmentCreate$inboundSchema,
});
/** @internal */
exports.EnrollAccountRequestCreate$outboundSchema = z.object({
    enrollment: enrollmentcreate_js_1.EnrollmentCreate$outboundSchema,
});
/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var EnrollAccountRequestCreate$;
(function (EnrollAccountRequestCreate$) {
    /** @deprecated use `EnrollAccountRequestCreate$inboundSchema` instead. */
    EnrollAccountRequestCreate$.inboundSchema = exports.EnrollAccountRequestCreate$inboundSchema;
