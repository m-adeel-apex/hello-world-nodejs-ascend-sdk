...
/** @internal */
exports.Percentage$outboundSchema = z.object({
    value: z.string().optional(),
});
/**
 * @internal
...
(function (Percentage$) {
    ...
    Percentage$.inboundSchema = exports.Percentage$inboundSchema;
...
/** @internal */
exports.ForeignBondTradingDetail$outboundSchema = z.object({
    percentage: z.nullable(z.lazy(() => exports.Percentage$outboundSchema)).optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
var ForeignBondTradingDetail$;
(function (ForeignBondTradingDetail$) {
    /** @deprecated use `ForeignBondTradingDetail$inboundSchema` instead. */
    ForeignBondTradingDetail$.inboundSchema = exports.ForeignBondTradingDetail$inboundSchema;
