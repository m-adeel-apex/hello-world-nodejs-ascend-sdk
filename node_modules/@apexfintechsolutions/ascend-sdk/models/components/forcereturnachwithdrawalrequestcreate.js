...
exports.ForceReturnAchWithdrawalRequestCreate$inboundSchema = z.object({
    nacha_return: nachareturncreate_js_1.NachaReturnCreate$inboundSchema,
    name: z.string(),
}).transform((v) => {
...
/** @internal */
exports.ForceReturnAchWithdrawalRequestCreate$outboundSchema = z.object({
    nachaReturn: nachareturncreate_js_1.NachaReturnCreate$outboundSchema,
    name: z.string(),
}).transform((v) => {
    return (0, primitives_js_1.remap)(v, {
 ...
 */
var ForceReturnAchWithdrawalRequestCreate$;
(function (ForceReturnAchWithdrawalRequestCreate$) {
    /** @deprecated use `ForceReturnAchWithdrawalRequestCreate$inboundSchema` instead. */
    ForceReturnAchWithdrawalRequestCreate$.inboundSchema = exports.ForceReturnAchWithdrawalRequestCreate$inboundSchema;
