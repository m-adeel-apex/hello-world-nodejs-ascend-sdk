 ...
 */
export async function scheduleTransfersUpdateAchWithdrawalSchedule(
...
> {
  const input:
    operations.AchWithdrawalSchedulesUpdateAchWithdrawalScheduleRequest = {
  ...
  const body = encodeJSON("body", payload.AchWithdrawalScheduleUpdate, {
    explode: true,
  });
