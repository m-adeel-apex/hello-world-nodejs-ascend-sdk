 ...
 */
export async function tradeBookingRebookExecution(
  ...
  >
> {
  const input: operations.BookingRebookExecutionRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.BookingRebookExecutionRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.RebookExecutionRequestCreate, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.BookingRebookExecutionResponse$inboundSchema, {
      key: "RebookExecutionResponse",
    }),
    M.jsonErr([400, 403, 404, 500, 503, 504], errors.Status$inboundSchema),
    M.fail(["4XX", "5XX"]),
    M.json("default", operations.BookingRebookExecutionResponse$inboundSchema, {
      key: "Status",
    }),
