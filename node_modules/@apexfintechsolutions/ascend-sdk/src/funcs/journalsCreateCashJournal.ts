 ...
 */
export async function journalsCreateCashJournal(
...
> {
  const parsed = safeParse(
    request,
    (value) => components.CashJournalCreate$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/transfers/v1/cashJournals")();
  ...
  >(
    M.json(
      200,
      operations.CashJournalsCreateCashJournalResponse$inboundSchema,
      { key: "CashJournal" },
    ),
