 ...
 */
export async function retirementsRetrieveContributionConstraints(
...
> {
  const input:
    operations.RetirementConstraintsRetrieveContributionConstraintsRequest = {
      retrieveContributionConstraintsRequestCreate:
        retrieveContributionConstraintsRequestCreate,
      accountId: accountId,
    };
  ...
  const body = encodeJSON(
    "body",
    payload.RetrieveContributionConstraintsRequestCreate,
    { explode: true },
  );
