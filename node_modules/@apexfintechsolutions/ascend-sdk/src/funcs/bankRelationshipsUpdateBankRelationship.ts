 ...
 */
export async function bankRelationshipsUpdateBankRelationship(
  ...
  >
> {
  const input: operations.BankRelationshipsUpdateBankRelationshipRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.BankRelationshipsUpdateBankRelationshipRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.BankRelationshipUpdate, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.BankRelationshipsUpdateBankRelationshipResponse$inboundSchema,
