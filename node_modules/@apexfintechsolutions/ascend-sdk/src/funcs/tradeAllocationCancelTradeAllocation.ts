 ...
 */
export async function tradeAllocationCancelTradeAllocation(
  ...
  >
> {
  const input: operations.BookingCancelTradeAllocationRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.BookingCancelTradeAllocationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.BookingCancelTradeAllocationResponse$inboundSchema, {
    ...
    M.json(
      "default",
      operations.BookingCancelTradeAllocationResponse$inboundSchema,
      { key: "Status" },
    ),
