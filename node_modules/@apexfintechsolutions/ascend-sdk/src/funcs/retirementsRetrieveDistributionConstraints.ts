 ...
 */
export async function retirementsRetrieveDistributionConstraints(
...
> {
  const input:
    operations.RetirementConstraintsRetrieveDistributionConstraintsRequest = {
      retrieveDistributionConstraintsRequestCreate:
        retrieveDistributionConstraintsRequestCreate,
      accountId: accountId,
    };
  ...
  const body = encodeJSON(
    "body",
    payload.RetrieveDistributionConstraintsRequestCreate,
    { explode: true },
  );
