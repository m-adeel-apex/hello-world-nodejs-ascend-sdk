 ...
 */
export async function bankRelationshipsReissueMicroDeposits(
  ...
  >
> {
  const input: operations.BankRelationshipsReissueMicroDepositsRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.BankRelationshipsReissueMicroDepositsRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.ReissueMicroDepositsRequestCreate, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.BankRelationshipsReissueMicroDepositsResponse$inboundSchema,
