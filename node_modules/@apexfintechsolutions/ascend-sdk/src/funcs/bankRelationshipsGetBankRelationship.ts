 ...
 */
export async function bankRelationshipsGetBankRelationship(
  ...
  >
> {
  const input: operations.BankRelationshipsGetBankRelationshipRequest = {
    accountId: accountId,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.BankRelationshipsGetBankRelationshipRequest$outboundSchema
        .parse(value),
  ...
  >(
    M.json(
      200,
      operations.BankRelationshipsGetBankRelationshipResponse$inboundSchema,
