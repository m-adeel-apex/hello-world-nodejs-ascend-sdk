 ...
 */
export async function scheduleTransfersCancelWireWithdrawalSchedule(
...
> {
  const input:
    operations.WireWithdrawalSchedulesCancelWireWithdrawalScheduleRequest = {
      cancelWireWithdrawalScheduleRequestCreate:
        cancelWireWithdrawalScheduleRequestCreate,
      accountId: accountId,
  ...
  const body = encodeJSON(
    "body",
    payload.CancelWireWithdrawalScheduleRequestCreate,
    { explode: true },
  );
