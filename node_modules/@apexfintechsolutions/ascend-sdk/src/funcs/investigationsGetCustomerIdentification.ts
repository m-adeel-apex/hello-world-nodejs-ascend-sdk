 ...
 */
export async function investigationsGetCustomerIdentification(
...
> {
  const input:
    operations.CustomerIdentificationResultServiceGetCustomerIdentificationRequest =
      {
  ...
  const pathParams = {
    ...
    customerIdentification_id: encodeSimple(
      "customerIdentification_id",
      payload.customerIdentification_id,
      { explode: false, charEncoding: "percent" },
    ),
  };
