 ...
 */
export async function journalsRetrieveCashJournalConstraints(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.RetrieveCashJournalConstraintsRequestCreate$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc(
    "/transfers/v1/cashJournals:retrieveCashJournalConstraints",
  )();
