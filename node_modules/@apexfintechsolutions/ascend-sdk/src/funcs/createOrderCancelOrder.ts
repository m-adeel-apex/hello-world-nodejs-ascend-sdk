 ...
 */
export async function createOrderCancelOrder(
  ...
  >
> {
  const input: operations.OrderServiceCancelOrderRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.OrderServiceCancelOrderRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CancelOrderRequestCreate, {
    explode: true,
  });
  ...
  const pathParams = {
    ...
    order_id: encodeSimple("order_id", payload.order_id, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.OrderServiceCancelOrderResponse$inboundSchema, {
      key: "Order",
    }),
    ...
    M.json(
      "default",
      operations.OrderServiceCancelOrderResponse$inboundSchema,
      { key: "Status" },
    ),
