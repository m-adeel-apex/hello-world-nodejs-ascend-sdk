 ...
 */
export async function tradeBookingGetTrade(
  ...
  >
> {
  const input: operations.BookingGetTradeRequest = {
    accountId: accountId,
    tradeId: tradeId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) => operations.BookingGetTradeRequest$outboundSchema.parse(value),
  ...
  >(
    ...
    M.fail(["4XX", "5XX"]),
    M.json("default", operations.BookingGetTradeResponse$inboundSchema, {
      key: "Status",
    }),
