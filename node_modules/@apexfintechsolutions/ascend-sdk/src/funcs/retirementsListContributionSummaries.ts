 ...
 */
export async function retirementsListContributionSummaries(
...
> {
  const input:
    operations.RetirementConstraintsListContributionSummariesRequest = {
      accountId: accountId,
      pageSize: pageSize,
      pageToken: pageToken,
    };
  ...
  >(
    M.json(
      ...
      { key: "ListContributionSummariesResponse" },
    ),
