 ...
 */
export async function bankRelationshipsCancelBankRelationship(
  ...
  >
> {
  const input: operations.BankRelationshipsCancelBankRelationshipRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.BankRelationshipsCancelBankRelationshipRequest$outboundSchema
        .parse(value),
  ...
  const body = encodeJSON("body", payload.CancelBankRelationshipRequestCreate, {
    explode: true,
  });
  ...
  >(
    M.json(
      200,
      operations.BankRelationshipsCancelBankRelationshipResponse$inboundSchema,
