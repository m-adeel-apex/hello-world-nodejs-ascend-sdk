 ...
 */
export async function scheduleTransfersCreateAchWithdrawalSchedule(
...
> {
  const input:
    operations.AchWithdrawalSchedulesCreateAchWithdrawalScheduleRequest = {
  ...
  const body = encodeJSON("body", payload.AchWithdrawalScheduleCreate, {
    explode: true,
  });
