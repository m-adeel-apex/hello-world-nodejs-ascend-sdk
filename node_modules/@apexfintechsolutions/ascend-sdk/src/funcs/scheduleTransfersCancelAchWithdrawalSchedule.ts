 ...
 */
export async function scheduleTransfersCancelAchWithdrawalSchedule(
...
> {
  const input:
    operations.AchWithdrawalSchedulesCancelAchWithdrawalScheduleRequest = {
      cancelAchWithdrawalScheduleRequestCreate:
        cancelAchWithdrawalScheduleRequestCreate,
      accountId: accountId,
  ...
  const body = encodeJSON(
    "body",
    payload.CancelAchWithdrawalScheduleRequestCreate,
    { explode: true },
  );
