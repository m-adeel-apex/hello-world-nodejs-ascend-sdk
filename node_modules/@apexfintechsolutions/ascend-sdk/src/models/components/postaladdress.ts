...
/** @internal */
export const PostalAddress$inboundSchema: z.ZodType<
  PostalAddress,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const PostalAddress$outboundSchema: z.ZodType<
...
export namespace PostalAddress$ {
  ...
  export const inboundSchema = PostalAddress$inboundSchema;
