...
/** @internal */
export const ServiceAccountCreds$inboundSchema: z.ZodType<
  ServiceAccountCreds,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const ServiceAccountCreds$outboundSchema: z.ZodType<
  ServiceAccountCreds$Outbound,
  z.ZodTypeDef,
  ServiceAccountCreds
> = z.object({
  privateKey: z.string(),
 ...
 */
export namespace ServiceAccountCreds$ {
  /** @deprecated use `ServiceAccountCreds$inboundSchema` instead. */
  export const inboundSchema = ServiceAccountCreds$inboundSchema;
  /** @deprecated use `ServiceAccountCreds$outboundSchema` instead. */
  export const outboundSchema = ServiceAccountCreds$outboundSchema;
