...
/** @internal */
export const PostalAddressCreate$inboundSchema: z.ZodType<
  PostalAddressCreate,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const PostalAddressCreate$outboundSchema: z.ZodType<
 ...
 */
export namespace PostalAddressCreate$ {
  /** @deprecated use `PostalAddressCreate$inboundSchema` instead. */
  export const inboundSchema = PostalAddressCreate$inboundSchema;
  /** @deprecated use `PostalAddressCreate$outboundSchema` instead. */
  export const outboundSchema = PostalAddressCreate$outboundSchema;
  /** @deprecated use `PostalAddressCreate$Outbound` instead. */
  export type Outbound = PostalAddressCreate$Outbound;
}
