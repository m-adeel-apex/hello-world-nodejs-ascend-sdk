...
/** @internal */
export const AccountDocumentUploadRequestCreate$inboundSchema: z.ZodType<
...
/** @internal */
export const AccountDocumentUploadRequestCreate$outboundSchema: z.ZodType<
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace AccountDocumentUploadRequestCreate$ {
  /** @deprecated use `AccountDocumentUploadRequestCreate$inboundSchema` instead. */
  export const inboundSchema = AccountDocumentUploadRequestCreate$inboundSchema;
