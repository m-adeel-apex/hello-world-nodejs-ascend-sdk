...
import {
  ...
  PhoneNumberShortCodeUpdate$inboundSchema,
  PhoneNumberShortCodeUpdate$Outbound,
  PhoneNumberShortCodeUpdate$outboundSchema,
} from "./phonenumbershortcodeupdate.js";
...
/** @internal */
export const PhoneNumberUpdate$inboundSchema: z.ZodType<
  PhoneNumberUpdate,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const PhoneNumberUpdate$outboundSchema: z.ZodType<
 ...
 */
export namespace PhoneNumberUpdate$ {
  /** @deprecated use `PhoneNumberUpdate$inboundSchema` instead. */
  export const inboundSchema = PhoneNumberUpdate$inboundSchema;
  /** @deprecated use `PhoneNumberUpdate$outboundSchema` instead. */
  export const outboundSchema = PhoneNumberUpdate$outboundSchema;
  /** @deprecated use `PhoneNumberUpdate$Outbound` instead. */
  export type Outbound = PhoneNumberUpdate$Outbound;
}
