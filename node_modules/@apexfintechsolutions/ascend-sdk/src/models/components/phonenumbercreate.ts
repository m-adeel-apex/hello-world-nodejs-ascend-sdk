...
import {
  ...
  PhoneNumberShortCodeCreate$outboundSchema,
} from "./phonenumbershortcodecreate.js";
...
/** @internal */
export const PhoneNumberCreate$inboundSchema: z.ZodType<
  PhoneNumberCreate,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const PhoneNumberCreate$outboundSchema: z.ZodType<
 ...
 */
export namespace PhoneNumberCreate$ {
  /** @deprecated use `PhoneNumberCreate$inboundSchema` instead. */
  export const inboundSchema = PhoneNumberCreate$inboundSchema;
