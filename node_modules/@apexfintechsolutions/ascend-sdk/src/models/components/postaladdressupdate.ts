...
/** @internal */
export const PostalAddressUpdate$inboundSchema: z.ZodType<
  PostalAddressUpdate,
  z.ZodTypeDef,
  unknown
> = z.object({
...
/** @internal */
export const PostalAddressUpdate$outboundSchema: z.ZodType<
 ...
 */
export namespace PostalAddressUpdate$ {
  /** @deprecated use `PostalAddressUpdate$inboundSchema` instead. */
  export const inboundSchema = PostalAddressUpdate$inboundSchema;
  /** @deprecated use `PostalAddressUpdate$outboundSchema` instead. */
  export const outboundSchema = PostalAddressUpdate$outboundSchema;
  /** @deprecated use `PostalAddressUpdate$Outbound` instead. */
  export type Outbound = PostalAddressUpdate$Outbound;
}
