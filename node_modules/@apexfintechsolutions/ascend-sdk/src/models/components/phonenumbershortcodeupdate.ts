...
/** @internal */
export const PhoneNumberShortCodeUpdate$inboundSchema: z.ZodType<
...
/** @internal */
export const PhoneNumberShortCodeUpdate$outboundSchema: z.ZodType<
 ...
 */
export namespace PhoneNumberShortCodeUpdate$ {
  /** @deprecated use `PhoneNumberShortCodeUpdate$inboundSchema` instead. */
  export const inboundSchema = PhoneNumberShortCodeUpdate$inboundSchema;
