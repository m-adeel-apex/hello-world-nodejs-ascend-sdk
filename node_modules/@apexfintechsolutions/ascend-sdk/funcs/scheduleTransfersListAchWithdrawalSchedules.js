...
exports.scheduleTransfersListAchWithdrawalSchedules = scheduleTransfersListAchWithdrawalSchedules;
 ...
 */
async function scheduleTransfersListAchWithdrawalSchedules(client, accountId, filter, pageSize, pageToken, options) {
    const input = {
        accountId: accountId,
        filter: filter,
        pageSize: pageSize,
    ...
    const [result] = await M.match(M.json(200, operations
        .AchWithdrawalSchedulesListAchWithdrawalSchedulesResponse$inboundSchema, { key: "ListAchWithdrawalSchedulesResponse" }), M.jsonErr([400, 403], errors.Status$inboundSchema), M.fail(["4XX", "5XX"]), M.json("default", operations
        .AchWithdrawalSchedulesListAchWithdrawalSchedulesResponse$inboundSchema, { key: "Status" }))(response, req, { extraFields: responseFields });
    if (!result.ok) {
        return result;
    }
    return result;
}
//# sourceMappingURL=scheduleTransfersListAchWithdrawalSchedules.js.map