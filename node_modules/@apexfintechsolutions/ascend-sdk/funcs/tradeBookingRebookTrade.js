 ...
 */
async function tradeBookingRebookTrade(client, rebookTradeRequestCreate, accountId, tradeId, options) {
    const input = {
    ...
    }), M.jsonErr([400, 403, 404, 500, 503, 504], errors.Status$inboundSchema), M.fail(["4XX", "5XX"]), M.json("default", operations.BookingRebookTradeResponse$inboundSchema, {
        key: "Status",
