 ...
 */
export declare function personManagementAssignLargeTrader(client: ApexascendCore, assignLargeTraderRequestCreate: components.AssignLargeTraderRequestCreate, legalNaturalPersonId: string, options?: RequestOptions): Promise<Result<operations.AccountsAssignLargeTraderResponse, errors.Status | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
