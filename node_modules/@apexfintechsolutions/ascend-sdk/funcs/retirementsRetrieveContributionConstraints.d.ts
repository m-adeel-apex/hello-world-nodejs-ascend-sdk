 ...
 */
export declare function retirementsRetrieveContributionConstraints(client: ApexascendCore, retrieveContributionConstraintsRequestCreate: components.RetrieveContributionConstraintsRequestCreate, accountId: string, options?: RequestOptions): Promise<Result<operations.RetirementConstraintsRetrieveContributionConstraintsResponse, errors.Status | SDKError | SDKValidationError | UnexpectedClientError | InvalidRequestError | RequestAbortedError | RequestTimeoutError | ConnectionError>>;
