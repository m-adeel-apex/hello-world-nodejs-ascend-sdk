...
exports.retirementsListContributionSummaries = retirementsListContributionSummaries;
 ...
 */
async function retirementsListContributionSummaries(client, accountId, pageSize, pageToken, options) {
    const input = {
        accountId: accountId,
        pageSize: pageSize,
        pageToken: pageToken,
    ...
    const path = (0, url_js_1.pathToFunc)("/transfers/v1/accounts/{account_id}/contributionSummaries")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .RetirementConstraintsListContributionSummariesResponse$inboundSchema, { key: "ListContributionSummariesResponse" }), M.jsonErr([400, 403], errors.Status$inboundSchema), M.fail(["4XX", "5XX"]), M.json("default", operations
