...
class ApexAccessTokenHook {
    ...
    async beforeRequest(hookCtx, request) {
        ...
        if (customSec.serviceAccountCreds) {
            ...
            const accessToken = await this.getAccessToken(serverUrl, customSec.apiKey, customSec.serviceAccountCreds);
    ...
    async getAccessToken(serverUrl, apiKey, serviceAccountCreds) {
    ...
    accessTokenStillValid() {
        ...
        return (this.accessTokenExpiration != null &&
            this.accessTokenExpiration > new Date());
    }
}
